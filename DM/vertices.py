...
V_7 = Vertex(name = 'V_7',
             particles = [ P.G0, P.G0, P.phi1__minus__, P.phi1__plus__ ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_52})

V_8 = Vertex(name = 'V_8',
             particles = [ P.G__minus__, P.G__plus__, P.phi1__minus__, P.phi1__plus__ ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_52})

V_9 = Vertex(name = 'V_9',
             particles = [ P.H, P.H, P.phi1__minus__, P.phi1__plus__ ],
             color = [ '1' ],
             lorentz = [ L.SSSS1 ],
             couplings = {(0,0):C.GC_52})

V_10 = Vertex(name = 'V_10',
              particles = [ P.phi1__minus__, P.phi1__minus__, P.phi1__plus__, P.phi1__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSSS1 ],
...
V_14 = Vertex(name = 'V_14',
              particles = [ P.H, P.phi1__minus__, P.phi1__plus__ ],
              color = [ '1' ],
              lorentz = [ L.SSS1 ],
...
V_53 = Vertex(name = 'V_53',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2, L.FFS3 ],
              couplings = {(0,0):C.GC_143,(0,1):C.GC_145})
...
V_61 = Vertex(name = 'V_61',
              ...
              color = [ '1' ],
              lorentz = [ L.FFS2, L.FFS3 ],
              couplings = {(0,0):C.GC_119,(0,1):C.GC_121})
...
V_76 = Vertex(name = 'V_76',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2, L.FFS3 ],
              couplings = {(0,0):C.GC_156,(0,1):C.GC_154})
...
V_78 = Vertex(name = 'V_78',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS2, L.FFS3 ],
              couplings = {(0,0):C.GC_148,(0,1):C.GC_146})
...
V_82 = Vertex(name = 'V_82',
              particles = [ P.P__tilde__Chi__minus__, P.P__tilde__Psi, P.phi1__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_122})

V_83 = Vertex(name = 'V_83',
              particles = [ P.NN1__tilde__, P.e__minus__, P.phi1__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_105})

V_84 = Vertex(name = 'V_84',
              particles = [ P.NN2__tilde__, P.mu__minus__, P.phi1__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_106})

V_85 = Vertex(name = 'V_85',
              particles = [ P.NN3__tilde__, P.ta__minus__, P.phi1__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_107})

V_86 = Vertex(name = 'V_86',
              particles = [ P.e__plus__, P.NN1, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_128})

V_87 = Vertex(name = 'V_87',
              particles = [ P.ve__tilde__, P.NN1, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_130})

V_88 = Vertex(name = 'V_88',
              particles = [ P.ve__tilde__, P.NN1, P.H ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_131})

V_89 = Vertex(name = 'V_89',
              particles = [ P.mu__plus__, P.NN2, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_133})

V_90 = Vertex(name = 'V_90',
              particles = [ P.vm__tilde__, P.NN2, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_135})

V_91 = Vertex(name = 'V_91',
              particles = [ P.vm__tilde__, P.NN2, P.H ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_136})

V_92 = Vertex(name = 'V_92',
              particles = [ P.ta__plus__, P.NN3, P.G__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_138})

V_93 = Vertex(name = 'V_93',
              particles = [ P.vt__tilde__, P.NN3, P.G0 ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_140})

V_94 = Vertex(name = 'V_94',
              particles = [ P.vt__tilde__, P.NN3, P.H ],
              color = [ '1' ],
              lorentz = [ L.FFS2 ],
              couplings = {(0,0):C.GC_141})

V_95 = Vertex(name = 'V_95',
              particles = [ P.P__tilde__Psi__tilde__, P.P__tilde__Chi__plus__, P.phi1__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS1 ],
              couplings = {(0,0):C.GC_122})

V_96 = Vertex(name = 'V_96',
              particles = [ P.e__plus__, P.NN1, P.phi1__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_105})

V_97 = Vertex(name = 'V_97',
              particles = [ P.mu__plus__, P.NN2, P.phi1__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_106})

V_98 = Vertex(name = 'V_98',
              particles = [ P.ta__plus__, P.NN3, P.phi1__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_107})

V_99 = Vertex(name = 'V_99',
              particles = [ P.NN1__tilde__, P.e__minus__, P.G__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFS3 ],
              couplings = {(0,0):C.GC_129})

V_100 = Vertex(name = 'V_100',
               particles = [ P.NN1__tilde__, P.ve, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_132})

V_101 = Vertex(name = 'V_101',
               particles = [ P.NN1__tilde__, P.ve, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_131})

V_102 = Vertex(name = 'V_102',
               particles = [ P.NN2__tilde__, P.mu__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_134})

V_103 = Vertex(name = 'V_103',
               particles = [ P.NN2__tilde__, P.vm, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_137})

V_104 = Vertex(name = 'V_104',
               particles = [ P.NN2__tilde__, P.vm, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_136})

V_105 = Vertex(name = 'V_105',
               particles = [ P.NN3__tilde__, P.ta__minus__, P.G__plus__ ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_139})

V_106 = Vertex(name = 'V_106',
               particles = [ P.NN3__tilde__, P.vt, P.G0 ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_142})

V_107 = Vertex(name = 'V_107',
               particles = [ P.NN3__tilde__, P.vt, P.H ],
               color = [ '1' ],
               lorentz = [ L.FFS3 ],
               couplings = {(0,0):C.GC_141})
...
V_183 = Vertex(name = 'V_183',
               ...
               couplings = {(0,0):C.GC_82,(0,1):C.GC_77})
...
V_186 = Vertex(name = 'V_186',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_81,(0,1):C.GC_76})
...
V_195 = Vertex(name = 'V_195',
               particles = [ P.P__tilde__Chi__minus__, P.P__tilde__Chi__plus__, P.a ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
               couplings = {(0,0):C.GC_4})

V_196 = Vertex(name = 'V_196',
               particles = [ P.P__tilde__Chi__minus__, P.P__tilde__Chi__plus__, P.Z ],
               color = [ '1' ],
               lorentz = [ L.FFV1 ],
