...
Decay_P__tilde__Chi__plus__ = Decay(name = 'Decay_P__tilde__Chi__plus__',
                                    ...
                                    partial_widths = {(P.phi1__plus__,P.P__tilde__Psi):'((2*MChi**2*yl1**2 - 2*Mphi1**2*yl1**2 + 4*MChi*MPsi*yl1**2 + 2*MPsi**2*yl1**2)*cmath.sqrt(MChi**4 - 2*MChi**2*Mphi1**2 + Mphi1**4 - 2*MChi**2*MPsi**2 - 2*Mphi1**2*MPsi**2 + MPsi**4))/(32.*cmath.pi*abs(MChi)**3)'})
...
Decay_e__minus__ = Decay(name = 'Decay_e__minus__',
                         ...
                         partial_widths = {(P.phi1__minus__,P.NN1):'((Me**2*y2e**2 + MNN1**2*y2e**2 - Mphi1**2*y2e**2)*cmath.sqrt(Me**4 - 2*Me**2*MNN1**2 + MNN1**4 - 2*Me**2*Mphi1**2 - 2*MNN1**2*Mphi1**2 + Mphi1**4))/(32.*cmath.pi*abs(Me)**3)',
...
Decay_H = Decay(name = 'Decay_H',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-12*MB**2*yb**2 + 3*MH**2*yb**2)*cmath.sqrt(-4*MB**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.phi1__minus__,P.phi1__plus__):'(lam1**2*vev**2*cmath.sqrt(MH**4 - 4*MH**2*Mphi1**2))/(16.*cmath.pi*abs(MH)**3)',
...
Decay_mu__minus__ = Decay(name = 'Decay_mu__minus__',
                          ...
                          partial_widths = {(P.phi1__minus__,P.NN2):'((MMU**2*y2m**2 + MNN2**2*y2m**2 - Mphi1**2*y2m**2)*cmath.sqrt(MMU**4 - 2*MMU**2*MNN2**2 + MNN2**4 - 2*MMU**2*Mphi1**2 - 2*MNN2**2*Mphi1**2 + Mphi1**4))/(32.*cmath.pi*abs(MMU)**3)',
...
Decay_NN1 = Decay(name = 'Decay_NN1',
                  ...
                  partial_widths = {(P.H,P.ve):'((-MH**2 + MNN1**2)*(-(MH**2*yNe**2)/2. + (MNN1**2*yNe**2)/2.))/(32.*cmath.pi*abs(MNN1)**3)',
                                    (P.phi1__plus__,P.e__minus__):'((Me**2*y2e**2 + MNN1**2*y2e**2 - Mphi1**2*y2e**2)*cmath.sqrt(Me**4 - 2*Me**2*MNN1**2 + MNN1**4 - 2*Me**2*Mphi1**2 - 2*MNN1**2*Mphi1**2 + Mphi1**4))/(32.*cmath.pi*abs(MNN1)**3)'})

Decay_NN2 = Decay(name = 'Decay_NN2',
                  particle = P.NN2,
                  partial_widths = {(P.H,P.vm):'((-MH**2 + MNN2**2)*(-(MH**2*yNm**2)/2. + (MNN2**2*yNm**2)/2.))/(32.*cmath.pi*abs(MNN2)**3)',
                                    (P.phi1__plus__,P.mu__minus__):'((MMU**2*y2m**2 + MNN2**2*y2m**2 - Mphi1**2*y2m**2)*cmath.sqrt(MMU**4 - 2*MMU**2*MNN2**2 + MNN2**4 - 2*MMU**2*Mphi1**2 - 2*MNN2**2*Mphi1**2 + Mphi1**4))/(32.*cmath.pi*abs(MNN2)**3)'})

Decay_NN3 = Decay(name = 'Decay_NN3',
                  particle = P.NN3,
                  partial_widths = {(P.H,P.vt):'((-MH**2 + MNN3**2)*(-(MH**2*yNt**2)/2. + (MNN3**2*yNt**2)/2.))/(32.*cmath.pi*abs(MNN3)**3)',
                                    (P.phi1__plus__,P.ta__minus__):'((MNN3**2*y2t**2 - Mphi1**2*y2t**2 + MTA**2*y2t**2)*cmath.sqrt(MNN3**4 - 2*MNN3**2*Mphi1**2 + Mphi1**4 - 2*MNN3**2*MTA**2 - 2*Mphi1**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MNN3)**3)'})

Decay_phi1__plus__ = Decay(name = 'Decay_phi1__plus__',
                           particle = P.phi1__plus__,
                           partial_widths = {(P.P__tilde__Chi__plus__,P.P__tilde__Psi__tilde__):'((-2*MChi**2*yl1**2 + 2*Mphi1**2*yl1**2 - 4*MChi*MPsi*yl1**2 - 2*MPsi**2*yl1**2)*cmath.sqrt(MChi**4 - 2*MChi**2*Mphi1**2 + Mphi1**4 - 2*MChi**2*MPsi**2 - 2*Mphi1**2*MPsi**2 + MPsi**4))/(16.*cmath.pi*abs(Mphi1)**3)',
                                             (P.NN1,P.e__plus__):'((-(Me**2*y2e**2) - MNN1**2*y2e**2 + Mphi1**2*y2e**2)*cmath.sqrt(Me**4 - 2*Me**2*MNN1**2 + MNN1**4 - 2*Me**2*Mphi1**2 - 2*MNN1**2*Mphi1**2 + Mphi1**4))/(16.*cmath.pi*abs(Mphi1)**3)',
                                             (P.NN2,P.mu__plus__):'((-(MMU**2*y2m**2) - MNN2**2*y2m**2 + Mphi1**2*y2m**2)*cmath.sqrt(MMU**4 - 2*MMU**2*MNN2**2 + MNN2**4 - 2*MMU**2*Mphi1**2 - 2*MNN2**2*Mphi1**2 + Mphi1**4))/(16.*cmath.pi*abs(Mphi1)**3)',
                                             (P.NN3,P.ta__plus__):'((-(MNN3**2*y2t**2) + Mphi1**2*y2t**2 - MTA**2*y2t**2)*cmath.sqrt(MNN3**4 - 2*MNN3**2*Mphi1**2 + Mphi1**4 - 2*MNN3**2*MTA**2 - 2*Mphi1**2*MTA**2 + MTA**4))/(16.*cmath.pi*abs(Mphi1)**3)'})

Decay_P__tilde__Psi = Decay(name = 'Decay_P__tilde__Psi',
                            particle = P.P__tilde__Psi,
                            partial_widths = {(P.phi1__minus__,P.P__tilde__Chi__plus__):'((2*MChi**2*yl1**2 - 2*Mphi1**2*yl1**2 + 4*MChi*MPsi*yl1**2 + 2*MPsi**2*yl1**2)*cmath.sqrt(MChi**4 - 2*MChi**2*Mphi1**2 + Mphi1**4 - 2*MChi**2*MPsi**2 - 2*Mphi1**2*MPsi**2 + MPsi**4))/(32.*cmath.pi*abs(MPsi)**3)'})
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.phi1__minus__,P.NN3):'((MNN3**2*y2t**2 - Mphi1**2*y2t**2 + MTA**2*y2t**2)*cmath.sqrt(MNN3**4 - 2*MNN3**2*Mphi1**2 + Mphi1**4 - 2*MNN3**2*MTA**2 - 2*Mphi1**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
